...
def parse_args():
    ...
    parser.add_argument('--chdir', type=str, help='Change the directory before executing the notebook to allow for relative imports.', required=False, default='/workspace/notebooks')
